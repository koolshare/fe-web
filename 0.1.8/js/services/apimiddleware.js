(function (angular) {
    ...
    angular.module('FileManagerApp').service('apiMiddleware', ['$window', 'fileManagerConfig', 'apiHandler',
        function ($window, fileManagerConfig, ApiHandler) {
            ...
            ApiMiddleware.prototype.historyTask = function (customDeferredHandler) {
                return this.apiHandler.historyTask(fileManagerConfig.historyTaskUrl, customDeferredHandler);
            };
            ApiMiddleware.prototype.listTask = function (routerId,customDeferredHandler) {
                return this.apiHandler.listTask(fileManagerConfig.listTaskUrl,routerId, customDeferredHandler);
            };
